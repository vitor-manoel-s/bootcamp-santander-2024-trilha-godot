...
func _process(delta: float):
	...
	# Processa animação e rotação de sprite
...
func rear_input():
	...
	# Apagar deadzone do input vector(controle)
	var deadzone = 0.15
...
func damage(amount: int) -> void:
	...
	health -= amount
	print("Jogador recebeu dano de ", amount, ". A vida total é ", health, "/", max_health)
...
func heal(amount: int) -> int:
	...
	if health > max_health:
		health = max_health
	print("Player recuperou ", amount, " de vida. A vida total é de ", health, "/", max_health)
	return health
